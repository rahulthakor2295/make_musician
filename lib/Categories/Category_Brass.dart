...
class BrassCategory extends StatefulWidget {
  const BrassCategory({super.key});

  @override
  State<BrassCategory> createState() => _BrassCategoryState();
}

class _BrassCategoryState extends State<BrassCategory> {
  ...
  fetchCategoryData() async{
    ...
    QuerySnapshot qn= await firestoreinstance.collection("products").where("product_category",isEqualTo: "Brass").get();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("BRASS INSTRUMENTS"),
