...
class StringCategory extends StatefulWidget {
  const StringCategory({super.key});

  @override
  State<StringCategory> createState() => _StringCategoryState();
}

class _StringCategoryState extends State<StringCategory> {
  @override
  final List products =[];
  ...
  fetchCategoryData() async{
    ...
    QuerySnapshot qn= await firestoreinstance.collection("products").where("product_category",isEqualTo: "String").get();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("STRING INSTRUMENTS"),
