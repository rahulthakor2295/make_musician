...
class PercussionCategory extends StatefulWidget {
  const PercussionCategory({super.key});

  @override
  State<PercussionCategory> createState() => _PercussionCategoryState();
}

class _PercussionCategoryState extends State<PercussionCategory> {
  ...
  fetchCategoryData() async{
    ...
    QuerySnapshot qn= await firestoreinstance.collection("products").where("product_category",isEqualTo: "Percussion").get();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("PERCUSSION INSTRUMENTS"),
